 ...
 */
final class Version20260305131243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours ADD CONSTRAINT FK_FDCA8C9CCCF9E01E FOREIGN KEY (departement_id) REFERENCES departement (id)');
